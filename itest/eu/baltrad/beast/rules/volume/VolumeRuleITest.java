...
public class VolumeRuleITest extends TestCase {
  ...
  public void testHandle_2() throws Exception {
    ...
    assertEquals("fixtures/scan_sehud_40.0_20110126T184700Z.h5", h_1845.triggeringFiles.get(0));
    String[] expected_1845_args = new String[]{"--source=sehud", "--date=20110126", "--time=184500", "--algorithm_id=10"};
    ...
    String[] expected_1900_args = new String[]{"--source=sehud", "--date=20110126", "--time=190000", "--algorithm_id=10"};
    ...
    String[] expected_1915_args = new String[]{"--source=sehud", "--date=20110126", "--time=191500", "--algorithm_id=10"};
    ...
    String[] expected_1930_args = new String[]{"--source=sehud", "--date=20110126", "--time=193000", "--algorithm_id=10"};
