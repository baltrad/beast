...
public class WrwpRuleManagerITest {
  ...
  public void test_update() throws Exception {
    ...
    rule.setConditionalMinElevationAngle(9.7);
    rule.setHeightThreshold(2549.0);
    rule.setMinNyquistInterval(7.9);
    rule.setNumberGapBins(11);
    rule.setMinNumberGapSamples(9);
    rule.setMaxNumberStandardDeviations(4);
    rule.setMaxVelocityDeviation(10.9);
    rule.setWrwpProcessingMethod("SMHI");
