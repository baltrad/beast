...
/**
 * Command response only containing status of operation
 * @author anders
 */
public class CommandResponseStatus implements CommandResponse {
   ...
   */
  public CommandResponseStatus(boolean status) {
    this.status = status;
  }
