...
public class TemplateNameCreatorMetadataNamer implements MetadataNamer, InitializingBean {
  ...
  static {
    pattern = Pattern.compile("\\$(?:" + "(\\$)|" + // group 1 matches escaped
                                                    // delimiter ($$)
        "\\{([_/a-z][_:/a-z0-9 #@+\\-\\.]*)\\}((.(tolower|toupper|substring|trim|rtrim|ltrim|interval_u|interval_l)(\\((([0-9]+)(,([0-9]+))?)?\\)))*)" + // group 2 matches the placeholder, group 3 matches all suboperations
