 ...
 * @author Anders Henja
 */
public class SecurityStorageException extends RuntimeException {
  /**
   ...
   */
  public SecurityStorageException(Throwable t) {
    super(t);
  }
   ...
   */
  public SecurityStorageException(String message, Throwable t) {
    super(message, t);
  }
}
