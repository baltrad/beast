 ...
 *
 */
public class BltGetAreasMessageTest {
  @Test
  public void testToDocument() {
    BltGetAreasMessage classUnderTest = new BltGetAreasMessage();
    Document result = classUnderTest.toDocument();
    assertEquals("blt_get_areas", result.getRootElement().getName());
  }
  ...
  public void testFromDocument_notBltCommand() {
    Document document = DocumentHelper.createDocument();
    document.addElement("blt_xget_areas");
    BltGetAreasMessage classUnderTest = new BltGetAreasMessage();
    try {
      classUnderTest.fromDocument(document);
